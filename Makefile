CC=clang
CFLAGS=-Wall -Wextra -g -Og -std=c11
...
$(BUILD_DIR)/everything.so: $(SRC_DIR)/everything.c $(SRC_DIR)/drawing.c $(SRC_DIR)/basic.c
	$(CC) -shared -fPIC -o $(BUILD_DIR)/everything.so $(SRC_DIR)/everything.c $(SRC_DIR)/drawing.c $(SRC_DIR)/basic.c $(CFLAGS)
